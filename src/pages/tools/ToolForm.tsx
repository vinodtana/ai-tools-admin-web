...
const ToolForm = ({ mode }: ToolFormProps) => {
  ...
  const { currentTool, isLoading, tools } = useAppSelector(
    (state) => state.tools
  );
  const { categories: categoriesList } = useAppSelector(
  ...
  const [dynamic_screenshot, setDynamicScreenshot] = useState<string | null>(
    null
  );
  ...
  useEffect(() => {
    console.log("ToolForm: Edit effect triggered", {
      mode,
      id,
  ...
  useEffect(() => {
    if (mode === "edit" && currentTool) {
      ...
      setKeyAchievements(
        currentTool.keyAchievements?.length ? currentTool.keyAchievements : [""]
      );
      ...
      setLaunchDate(
        currentTool.launchDate ? new Date(currentTool.launchDate) : undefined
      );
    }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Essential details about the AI tool
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              {type === "tools" && (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="usersCount" {...register("usersCount")} />
                  </div>
                </>
              )}
              ...
              {type === "tools" && (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="viewsCount" {...register("viewsCount")} />
                  </div>
                </>
              )}
              {type === "news" && (
                <div className="space-y-2">
                  ...
                  <Input id="newslink" type="url" {...register("newslink")} />
                </div>
              )}
            ...
            <ImageUpload
              ...
              onChange={(value) => {
                ...
                setBannerImage(value as string);
              }}
              multiple={false}
              required={true}
            />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add key features, use cases, pros, and cons
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* {mode==="create" && ( */}
              <textarea
                className="text_area_sec_temp"
                onChange={(e) => {
                  console.log("e.target.value;", e.target.value);
                  const linesArray = e.target.value
                    .split(/\r?\n/)
                    .map((line) => line.trim())
                    .filter((line) => line.length > 0);
                  setFeatures(linesArray);
                  const neew22 = JSON.stringify(linesArray, null, 2);
                  console.log("neew22", neew22);
                }}
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      ...
                      const linesArray = e.target.value
                        ...
                        .map((line) => line.trim())
                        .filter((line) => line.length > 0);
                      setToolPros(linesArray);
                      const neew22 = JSON.stringify(linesArray, null, 2);
                      console.log("neew22", neew22);
                    }}
                    placeholder="Enter Tool Pros"
                  />
                  {toolPros.map((pro, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setToolPros(toolPros.filter((_, i) => i !== index))
                        }
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      ...
                      const linesArray = e.target.value
                        ...
                        .map((line) => line.trim())
                        .filter((line) => line.length > 0);
                      setToolCons(linesArray);
                      const neew22 = JSON.stringify(linesArray, null, 2);
                      console.log("neew22", neew22);
                    }}
                    placeholder="Enter Tool Cons"
                  />
                  {toolCons.map((con, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setToolCons(toolCons.filter((_, i) => i !== index))
                        }
                ...
                {keyAchievements.map((con, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setKeyAchievements(
                          keyAchievements.filter((_, i) => i !== index)
                        )
                      }
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set the visibility status of this tool
            </CardDescription>
          </CardHeader>
          <CardContent>
